...
class ImportController extends Controller
{
    ...
    private const EMPLOYEE_COLUMNS = [
        ...
        'pay_cycle', 'pay_type',
        'hourly_rate', 'overtime_rate', 'billable_rate', 'st_burden_rate', 'ot_burden_rate',
    ...
    private function buildEmployeePayload(array $data, $craftsByName): array
    {
        ...
        return [
            ...
            // Legacy single `burden_rate` column maps to `st_burden_rate` for
            // backwards-compatibility with older CSVs.
            'st_burden_rate'      => $this->toDecimal($data['st_burden_rate'] ?? $data['burden_rate'] ?? 0, 4),
            'ot_burden_rate'      => $this->toDecimal($data['ot_burden_rate'] ?? 0, 4),
    ...
    private function normalizeHeader(array $rawHeader): array
    {
        $aliases = [
            ...
            'burden rate'       => 'st_burden_rate',
            'burden'            => 'st_burden_rate',
            'st burden'         => 'st_burden_rate',
            'st burden rate'    => 'st_burden_rate',
            'straight time burden' => 'st_burden_rate',
            'ot burden'         => 'ot_burden_rate',
            'ot burden rate'    => 'ot_burden_rate',
            'overtime burden'   => 'ot_burden_rate',
