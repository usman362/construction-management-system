...
<div class="space-y-6" x-data="{ activeTab: 'overview' }">
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="flex flex-wrap gap-2 px-6 py-3 bg-gray-50 border-b border-gray-200">
            ...
            <a href="{{ route('projects.drawings.index', $project) }}" class="text-sm px-3 py-1.5 bg-white border border-gray-300 rounded-lg hover:bg-purple-50 hover:border-purple-300 hover:text-purple-700 transition text-gray-700">Drawings</a>
            <a href="{{ route('projects.cost-codes.index', $project) }}" class="text-sm px-3 py-1.5 bg-white border border-gray-300 rounded-lg hover:bg-amber-50 hover:border-amber-300 hover:text-amber-700 transition text-gray-700">Phase Codes</a>
