...
function editShift(id){
    $.get(window.BASE_URL+'/shifts/'+id+'/edit', function(d){
        ...
        document.getElementById('editSaveBtn').onclick=function(){ submitForm('editForm',window.BASE_URL+'/shifts/'+d.id,'PUT',table,'editModal'); };
        openModal('editModal');
    });
}

function viewShift(id){
    $.get(window.BASE_URL+'/shifts/'+id, function(d){
