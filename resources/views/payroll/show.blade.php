...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="flex gap-4 mb-8 flex-wrap">
            ...
            @if($entries->isNotEmpty())
                <a href="{{ route('payroll.export', $payrollPeriod) }}" class="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-2 px-6 rounded">
