...
function editInvoice(id){
    $.get('/invoices/'+id+'/edit', function(d){
        ...
        document.getElementById('editSaveBtn').onclick = function(){ submitForm('editForm','/invoices/'+d.id,'PUT',table,'editModal'); };
        openModal('editModal');
    });
}

function viewInvoice(id){
    $.get('/invoices/'+id, function(d){
