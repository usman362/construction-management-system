        ...
        <div class="bg-gray-50 p-6 rounded-lg mb-8 border border-gray-200">
            <form method="GET" action="{{ route('reports.timesheets') }}" class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="week_ending" value="{{ request('week_ending', isset($weekly['week_ending']) ? $weekly['week_ending']->format('Y-m-d') : '') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
