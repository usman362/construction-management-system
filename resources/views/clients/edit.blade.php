...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form action="{{ route('clients.update', $client) }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Legacy Vendor Code</label>
                <input
                    type="text"
                    name="vendor_code"
                    placeholder="From legacy system"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('vendor_code') border-red-500 @enderror"
                    value="{{ old('vendor_code', $client->vendor_code) }}"
                >
                @error('vendor_code')
