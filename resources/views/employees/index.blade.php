...
<div id="createModal" class="hidden fixed inset-0 z-50 flex items-center justify-center modal-overlay" onclick="if(event.target===this)closeModal('createModal')">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4">
        ...
        <form id="createForm" class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div><label class="block text-sm font-medium text-gray-700 mb-1">Craft ID</label><input type="text" name="craft_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"></div>
...
function editEmployee(id){
    $.get('/employees/'+id+'/edit', function(d){
        ...
        document.getElementById('editSaveBtn').onclick=function(){ submitForm('editForm','/employees/'+d.id,'PUT',table,'editModal'); };
        openModal('editModal');
    });
}
</script>
