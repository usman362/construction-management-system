            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    >
                        ...
                        @foreach($crafts as $craft)
                            <option value="{{ $craft->id }}" {{ old('craft_id', $employee->craft_id) == $craft->id ? 'selected' : '' }}>
                                {{ $craft->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="field" {{ old('role', $employee->role) === 'field' ? 'selected' : '' }}>Field</option>
                        <option value="foreman" {{ old('role', $employee->role) === 'foreman' ? 'selected' : '' }}>Foreman</option>
                        <option value="superintendent" {{ old('role', $employee->role) === 'superintendent' ? 'selected' : '' }}>Superintendent</option>
                        <option value="project_manager" {{ old('role', $employee->role) === 'project_manager' ? 'selected' : '' }}>Project Manager</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('billable_rate', $employee->billable_rate) }}"
                    >
                    @error('billable_rate')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
