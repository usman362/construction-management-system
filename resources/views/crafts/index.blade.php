...
function editCraft(id){
    $.get('/crafts/'+id+'/edit', function(d){
        ...
        document.getElementById('editSaveBtn').onclick=function(){ submitForm('editForm','/crafts/'+d.id,'PUT',table,'editModal'); };
        openModal('editModal');
    });
}

function viewCraft(id){
    $.get('/crafts/'+id, function(d){
