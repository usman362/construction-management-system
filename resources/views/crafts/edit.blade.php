...
@section('title', 'Edit Craft')

@section('content')
<div class="max-w-2xl mx-auto space-y-6">
    <h1 class="text-3xl font-bold text-gray-900">Edit Craft</h1>

    <form action="{{ route('crafts.update', $craft) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('base_hourly_rate', $craft->base_hourly_rate) }}"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('overtime_multiplier', $craft->overtime_multiplier) }}"
                    >
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('billable_rate', $craft->billable_rate) }}"
                    >
                    @error('billable_rate')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
