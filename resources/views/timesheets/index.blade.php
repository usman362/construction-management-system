...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    <table id="dataTable" class="w-full">
        <thead><tr>
            <th>Date</th><th>Employee</th><th>Project</th><th>Crew</th><th>Regular</th><th>OT</th><th>DT</th><th>Total</th><th>Cost</th><th>Status</th><th class="text-center" width="100">Actions</th>
        </tr></thead>
    </table>
</div>
...
var table = $('#dataTable').DataTable({
    ...
    columns: [
        {data:'date', render: d=>d?new Date(d).toLocaleDateString():'—'}, {data:'employee_name'}, {data:'project_name'}, {data:'crew_name'},
