...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center gap-2">
            {{-- 2026-05-10 (Brenda): Snap-an-Invoice on client billing —
                 same UX as the version on /invoices. --}}
            <button onclick="openInvoiceScanModal()" class="relative inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 via-fuchsia-600 to-pink-600 hover:from-purple-700 hover:via-fuchsia-700 hover:to-pink-700 text-white text-sm font-semibold px-4 py-2.5 rounded-lg shadow-md transition" title="Snap a photo of an invoice — AI fills it in for you">
...
{{-- ───── Snap-an-Invoice (AI OCR) modal ─────
     Brenda 2026-05-10. 3 stages: upload → extracting → review.
     POSTs to /billing/scan-photo then /billing/scan-commit. --}}
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-purple-600 via-fuchsia-600 to-pink-600 text-white">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-purple-100" x-text="stage === 'review' ? (summary || 'Review and save') : 'Photo of an invoice → AI fills in the form'"></p>
                </div>
            </div>
        ...
        <div x-show="stage === 'upload'" class="p-6">
            <label class="block">
                ...
                <div class="border-2 border-dashed border-purple-300 rounded-xl p-12 text-center hover:bg-purple-50 transition cursor-pointer"
                    ...
                    <p class="mt-4 text-base font-semibold text-gray-900">Drop an invoice here, or click to choose</p>
                    <p class="mt-1 text-xs text-gray-500">JPG, PNG, HEIC up to 10 MB.</p>
                </div>
            </label>
        </div>
...
// 2026-05-10 (Brenda): Snap-an-Invoice on /billing — opens AI capture modal.
...
function snapInvoice(){
    return {
        ...
        form: {
            project_id: '', vendor_name: '', purchase_order_id: null,
        ...
        reset() {
            ...
            this.form = { project_id: '', vendor_name: '', purchase_order_id: null,
                          invoice_number: '', invoice_date: '', due_date: '',
                          po_reference: '', total_amount: '', description: '' };
        ...
        get canCommit() {
            ...
            return this.form.project_id && this.form.invoice_number
                && this.form.invoice_date && this.form.total_amount;
        },
        ...
        async commit() {
            ...
            const payload = {
                ...
                description:       [this.form.vendor_name, this.form.description].filter(Boolean).join(' — ') || null,
