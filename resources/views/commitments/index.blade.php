    ...
    table = $('#dataTable').DataTable({
        ...
        columns: [
            ...
            {data:'status', name:'status', render: function(d) {
                ...
                return '<span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium '+(statusColors[d]||'bg-gray-100 text-gray-800')+'">'+d.charAt(0).toUpperCase()+d.slice(1)+'</span>';
